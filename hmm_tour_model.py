...
class HMM_Tour:
    ...
    def __init__( self, delta ):
        ...
        self.noise_angle_distrib = UniformDistrib( -np.pi, np.pi, UniformDistribTrainer() )
        self.noise_joint_distrib = JointIndependentDistrib(
                [ self.noise_angle_distrib, self.noise_dist_distrib ],
                JointIndependentDistribTrainer() )
